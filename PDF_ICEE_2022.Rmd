...
.center[
<img  src="img/logos.PNG" width="300px"
/>
...
Diapo 13: Metodología

Finally, we relate our global interest rate factor and the functional components of profitability in the DLN model. This model allows the construction of a response surface where the effects of the WIR on profitability are represented. An advantage of this analysis is to observe the effect through the lags of the predictor variable.
...
```{r echo=FALSE, out.width = "100%" }
knitr::include_graphics("img/newplot.png")
```
