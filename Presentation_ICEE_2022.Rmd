...
This research is carried out in conjunction with my thesis supervisors, Professor Diego Manotas from the Universidad del Valle, and Professor Jorge M. Uribe from the Universidad Oberta de Cataluña.
...
Understanding the causes or generation of company profitability has always been a topic of interest in the academic and business world. Although, different companies may in turn present different causes or events that determine their profitability, depending on the structure of their operations or composition of assets. We could mainly identify two foci of the determinants.
...
The importance of profitability lies in its relevance as an indicator of efficient management in terms of utility and benefit for companies. Although the companies in the energy sector have a similarity in terms of their purpose of generating energy, the source of generation causes certain differences in the type of operation and management strategies to maximize the value of the companies.

It is here in administration or decision-making that the understanding of internal or external phenomena that can affect companies becomes vital.

Internal or idiosyncratic characteristics can be firms'  age, or size, financial leverage, etc., and the external determinants can be fuel prices, interest rates, exchange rates, economic activity, etc. Many other internal and external measurable characteristics can be listed.
...
Currently, in the face of different changes in economic cycles driven by different acceleration or deceleration behaviors, changes in commodity prices, even wars and pandemics,... These events cause monetary regulators to make the decision to control liquidity in order to stimulate the economy or not.. Obviously, companies in the energy sector are no strangers to these movements, much less management decisions on profitability.

Here we analyze the external determinants of the profitability of energy companies and, in particular, the effect of global liquidity on the profitability of companies belonging to different energy subsectors.

Where, our working hypothesis is that changes in global interest rates have important effects on the financial operation of large energy companies.
...
All companies are exposed to changes in global liquidity. However, the profitability response of companies in the different energy subsectors can be very different due to the different activities carried out by energy companies.

In the case of oil, coal or gas companies, for example Ratti and Vespignani (2016) (tueny-sixtin), Hammoudeh et al. (2015)(tueny-fivetin), Díez-Esteban et al (2017)(tueny seventin) show that variations in interest rates affect the prices of raw materials, mainly the price of oil and raw materials, an issue that modifies the profitability of companies.

In the renewable energy sector, authors such as Sutherland (2019)(tueny ninetin), Schmidt et al (2019)(tuenyninetin) show that interest rates have an effect on economic stimuli and subsidies. These implications affect decision-making to maximize the value of companies.
...
First, we construct a common factor from different developed market interest rates. This factor is called the world interest rate and is our indicator of global liquidity.

Second, we estimate a common factor of return for firms in each subsector. We do this using Principal Functional Component Analysis

Third, we measure the effect of global liquidity on returns using the nonlinear distributed lag model.
...
Finally, we relate our global interest rate factor and the functional components of return in the DLN model. This model allows the construction of a response surface where the effects of the WIR on profitability are represented. An advantage of this analysis is to observe the effect through the lags of the predictor variable.
...
We use ROA, this is Return on Assets, ROA measures the operating efficiency of a company regardless of its financial structure. This is calculated by dividing a company's net income before financing costs by total assets.

We have a total of 536 companies, with a greater participation of Oil and Gas companies, then companies related to equipment and services, renewable energies, coal and uranium.



Regarding global liquidity information, we use short and long-term interest rates for 21 countries of developed economies.



Finally, we present the distribution of the 536 companies in our sample. The US and Canada stand out with 255 and 114 respectively. This map allows visualizing that geographically our sample is well distributed.
...
Subsequently, this figure is the result of the DLN model. Here, we present the response surface which has 3 dimensions. Profitability, WIR and Lag.
...
.right-column[
.font120[
> El efecto de la liquidez global sobre la rentabilidad de las empresas de energía es completamente no lineal, es decir asimétrico.
...
> La rentabilidad de las empresas energéticas se ve afectada de manera diferente según su subsector respecto a la liquidez global.
...
.right-column[
.font120[
> Aumentos en la liquidez global, i.e., WIR negativa, presentan efectos más fuertes en la rentabilidad, pero estos no son persitentes en el tiempo.
...
> La disminución en las tasas de interés implica la intervención de diferentes autoridades monetarias para impulsar la liquidez, respaldar el crecimiento económico y restaurar la estabilidad financiera. Empresas como oil & gas que su rentabilidad depende principalmente de los precios del oil and gas, muestran que, ante tasas de interés bajas el efecto contemporáneo sobre la rentabilidad es negativo. Esto principalmente por condiciones de bajo precio en las materias primas, desaceleración en la economía, etc. Solamente después del segundo o tercer trimestre empieza a aumentar positivamente el efecto sobre la rentabilidad.
...
.font120[
> Las empresas de Uranium muestran efectos positivos fuertes sobre la rentabilidad ante aumentos en la liquidez mundial (i.e., WIR negativa).
Las empresas de energías renovables y oil & gas relacionadas con equipment and services son menos sensibles ante las variaciones en la liquidez mundial.
