...
# Interpretación de lo anterior (Esto no va..)

**COAL**
Cuando la WIR disminuye de manera extrema, es decir hay un aumento en la liquidez global, las empresas de coal perciben un efecto positivo sobre la rentabilidad de manera instantánea. Después de unos trimestres (3 en adelante), este efecto se invierte y se perciben efectos negativos sobre la rentabilidad.

**OIL & GAS**
Cuando la WIR disminuye y principalmente de manera extrema, es decir hay un aumento en la liquidez global, las empresas de oil & gas perciben un efecto negativo muy fuerte sobre la rentabilidad de manera instantánea y se prolonga por los siguientes tres a cuatro trimestres. Después de unos trimestres (6 en adelante), este efecto se invierte y se perciben efectos positivos sobre la rentabilidad.

**OIL & GAS (Equipment and services)**
Cuando la WIR disminuye de manera extrema, es decir hay un aumento en la liquidez global, las empresas de oil & gas (Equipos y servicios) perciben un pequeño efecto negativo sobre la rentabilidad de manera instantánea y en el siguiente trimestre. De manera general, este subsector no percibe grandes efectos ante variaciones en la liquidez mundial.

**RENEWABLE**
Cuando la WIR disminuye de manera extrema, es decir hay un aumento en la liquidez global, las empresas de energía renovables perciben un efecto negativo sobre la rentabilidad de manera instantánea y en el siguiente trimestre.

**URANIUM**
Cuando la WIR disminuye de manera extrema, es decir hay un aumento en la liquidez global, las empresas de energía de Uranio perciben un pequeño efecto negativo sobre la rentabilidad de manera instantánea. Posterior al segundo trimestre existe un efecto positivo sobre la rentabilidad.
